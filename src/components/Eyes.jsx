...
function Eyes() {
  ...
  return (
    <div className='eyes h-screen w-full overflow-hidden'>
        <div data-scroll data-scroll-speed="-.7" className="relative w-full h-full bg-cover bg-center bg-[url(https://images.unsplash.com/photo-1517902610345-76683f9f3a1f?q=80&w=1785&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)]">
